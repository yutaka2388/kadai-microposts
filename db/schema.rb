...
ActiveRecord::Schema.define(version: 20190316170255) do
  ...
  create_table "relationship2s", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["favorite_id"], name: "index_relationship2s_on_favorite_id", using: :btree
    t.index ["micropost_id", "favorite_id"], name: "index_relationship2s_on_micropost_id_and_favorite_id", unique: true, using: :btree
  ...
  add_foreign_key "relationship2s", "microposts", column: "favorite_id"
